...
public class ParameterFactory {
    ...
    public static EditorElement create(TemplateParameter parameter, Main main, EditorFrame editorFrame) {
        return switch (parameter.dataType()) {
            ...
            case STRING_SET -> new ParameterFieldStringSet(editorFrame, parameter.optional(), parameter.name());
            ...
            case ENUM -> new ParameterFieldEnum(editorFrame, parameter.optional(), parameter.name(), parameter.enumOptions().toArray(new String[0]));
