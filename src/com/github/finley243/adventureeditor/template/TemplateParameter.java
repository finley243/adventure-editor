...
public record TemplateParameter(String id, ParameterDataType dataType, String name, String type, List<String> enumOptions, boolean topLevelOnly, boolean isAttribute, boolean isTagContent) {
