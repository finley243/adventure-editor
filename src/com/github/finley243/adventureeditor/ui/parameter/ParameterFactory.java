...
public class ParameterFactory {
    ...
    public ParameterFactory(TemplateRegistry templateRegistry, DataManager dataManager, DataSaveTarget topLevelSaveTarget) {
    ...
    public ParameterField create(TemplateParameter parameter, EditorFrame editorFrame, ParameterField parentField) {
        ParameterField parameterElement = switch (parameter.dataType()) {
            ...
            case OBJECT_SET -> new ParameterFieldObjectSet(editorFrame, parameter.optional(), parameter.name(), parentField, templateRegistry.getTemplate(parameter.type()), false, this);
            case OBJECT_SET_UNIQUE -> new ParameterFieldObjectSet(editorFrame, parameter.optional(), parameter.name(), parentField, templateRegistry.getTemplate(parameter.type()), true, this);
            case REFERENCE -> new ParameterFieldReference(editorFrame, parameter.optional(), parameter.name(), parentField, parameter.type(), dataManager.getIDsForCategoryArray(parameter.type()), dataManager, topLevelSaveTarget, this);
            case REFERENCE_SET -> new ParameterFieldReferenceSet(editorFrame, parameter.optional(), parameter.name(), parentField, templateRegistry.getTemplate(parameter.type()), dataManager, topLevelSaveTarget, this);
