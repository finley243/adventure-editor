...
public class InternalTemplates {
    ...
    public static final Template SCRIPT_TEMPLATE = new Template("script", "Script", false, false, new ArrayList<>(), new ArrayList<>(), new ArrayList<>() {{
    ...
    public static final Template PHRASE_TEMPLATE = new Template("phrase", "Phrase", false, false, new ArrayList<>(), new ArrayList<>(), new ArrayList<>() {{
